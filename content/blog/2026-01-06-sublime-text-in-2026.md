...
I was using [Sublime Text](https://www.sublimetext.com/) back in 2016, or so. After using [Atom](https://atom-editor.cc/), [VS Code](https://code.visualstudio.com/), and most recently [Zed](https://zed.dev/), I'm almost back to Sublime Text (now version 4) again.
