...
Hugo, written in Go, may be the fastest of the SSGs in building a site. But Zola, written in Rust, is every bit as fast. Nether disappoints and builds so fast you almost don't notice. This site builds in 45ms, or less, with Zola.

Blogs are not very complicated websites so Zola has what you need to create one. It's a little simpler than Hugo so is missing a few things that Hugo does well.
